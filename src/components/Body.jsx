    ...
    return (
        <main className="mx-5 mt-16 md:relative md:left-[48vw] md:top-0 md:mx-0 md:mt-0 md:w-[39.5vw] md:pl-[4vw] md:pt-[11vh]">
            <section id="projects-section">
                <h2 className="section-title mb-3 font-raleway text-3xl font-extrabold text-black lg:mb-4 lg:text-4xl xl:mb-5 2xl:text-5xl">Projects</h2>
                <BodyContainer
                ...
                <div className="section-tag-container my-2 flex flex-row flex-wrap items-center gap-2 xl:my-2.5 xl:gap-2.5 2xl:my-3 2xl:gap-3">
                    ...
                    <span className="section-tag rounded-full bg-black px-2 py-0.5 text-center text-xs font-normal text-pink-300 lg:px-2.5 lg:text-2xs xl:py-1 xl:text-xs 2xl:px-3 2xl:text-sm">TCP connection</span>
                </div>
                <p className="section-paragraph text-xs font-medium text-black lg:text-xs lg:leading-normal xl:text-sm 2xl:text-base mb-3 xl:mb-3.5 2xl:mb-4">
                    This is a chess game where you can challenge your friends to game of chess with all chess functionalities. The connection between the 2 players were doen using a TCP connection with expressJS and NodeJS. The front-end was made using ReactJS and Material UI library.
                </p>
                <div
                    className={`${
