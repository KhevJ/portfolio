        ...
        <div>
            <div className=" text-lg">
                ...
                >
                    ...
                    <div className=" relative  top-6 md:absolute md:top-auto md:bottom-0  left-0   w-full items-center justify-between">
                        <div className="flex flex-row items-center gap-8 lg:gap-10 2xl:gap-12 ">
                        <a
                        ...
                        >
                            ...
                            height={98}
                            viewBox="0 0 98 98"
                            className="fill-black transition-transform hover:-translate-y-1 hover:fill-lime-400  w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 2xl:h-12 2xl:w-12"
                            >
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                        ...
                        >
                            ...
                            height={72}
                            viewBox="0 0 72 72"
                            className="fill-black transition-transform hover:-translate-y-1 hover:fill-blue-400 w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 2xl:h-12 2xl:w-12"
                            >
                            <path
